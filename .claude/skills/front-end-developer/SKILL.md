...
description: Senior Front-end developer/Software Engineer. Use when building a new feature or modifying codebase. Use when the user asks to "create a feature", "implement a feature", "need to create/update". Create distinctive, production-grade frontend interfaces. Use this skill when the user asks to build web components, pages. Generates creative, polished code that avoids generic AI aesthetics.
effort: high
---
